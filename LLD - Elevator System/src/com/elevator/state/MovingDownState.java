...
public class MovingDownState implements ElevatorState {
    ...
    public void closeDoor() {
        System.out.println("Closing door while moving down.");
    }

    @Override
    public void move(Elevator elevator) {
        int nextFloor = elevator.getCurrentFloor() - 1;
        System.out.println("Elevator no. " + elevator.getId() + " Moving down from floor " + elevator.getCurrentFloor() + " to floor " + nextFloor);
    ...
    public void stop(Elevator elevator) {
        ...
        elevator.setCurrentDirection(Direction.IDLE); // Set direction to IDLE
